...
main = tkinter.Tk()
main.title("Automatic Facial Expression Recognition using CNN & RNN Algorithm") #designing main screen
...
font = ('times', 13, 'bold')
title = Label(main, text='Automatic Facial Expression Recognition using CNN & RNN Algorithm')
